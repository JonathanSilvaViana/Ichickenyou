...
public class AnyGenderFriends extends AppCompatActivity {
    ...
    ArrayAdapter<String> varios_nomes, partes_galinha, gosta_de_fazer_ou_faz, partes_da_galinha_versao_coreana;
    ...
    String[] varios_nomes_combinados;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_any_gender_friends);
        ...
        //combina nomes diversos
        varios_nomes_combinados = ArrayUtils.addAll(getResources().getStringArray(R.array.malenames), getResources().getStringArray(R.array.femalenames));

        //cria o array adapter de vários nomes diferentes
        varios_nomes = new ArrayAdapter<String>(this, android.R.layout.simple_dropdown_item_1line, varios_nomes_combinados);
        ...
        nome_autocomplete.setAdapter(varios_nomes);
        ...
        bt_avanca_resultado.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(AnyGenderFriends.this, "Something wrong about language, alert the developer", Toast.LENGTH_SHORT).show();
                ...
                Intent vai_ao_resultado = new Intent(AnyGenderFriends.this, ResultActivity.class);
        ...
        bt_adicionar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int form = 0; form < 1; form ++)
                {
                    ...
                    final TextView txtVw_escolhanome = new TextView(AnyGenderFriends.this);
                    ...
                    final AutoCompleteTextView nome_autocomplete_field = new AutoCompleteTextView(AnyGenderFriends.this);
                    nome_autocomplete_field.setId(form + 1);
                    final int index2 = form;
                    nome_autocomplete_field.setAdapter(varios_nomes);
                    ...
                    final TextView txtVw_escolhaparte = new TextView(AnyGenderFriends.this);
                    ...
                    final Spinner galinha_spinner = new Spinner(AnyGenderFriends.this);
                    ...
                    final TextView txtVw_escolhaacao = new TextView(AnyGenderFriends.this);
                    ...
                    final AutoCompleteTextView nome_acao_field = new AutoCompleteTextView(AnyGenderFriends.this);
                    ...
                    final TextView linha_separador = new TextView(AnyGenderFriends.this);
                    ...
                    final Button bt_delete_form = new Button(AnyGenderFriends.this);
                    ...
                    final TextView linha_separador2 = new TextView(AnyGenderFriends.this);
                    ...
                    final TextView linha_separador3 = new TextView(AnyGenderFriends.this);
