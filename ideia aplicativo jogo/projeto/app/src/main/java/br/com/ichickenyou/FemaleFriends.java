...
public class FemaleFriends extends AppCompatActivity {
    ...
    ArrayAdapter<String> nomes_femininos, partes_galinha, gosta_de_fazer_ou_faz, partes_da_galinha_versao_coreana;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_female_friends);
        ...
        nomes_femininos = new ArrayAdapter<String>(this, android.R.layout.simple_dropdown_item_1line, getResources().getStringArray(R.array.femalenames));
        ...
        nome_autocomplete.setAdapter(nomes_femininos);
        ...
        bt_avanca_resultado.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(FemaleFriends.this, "Something wrong about language, alert the developer", Toast.LENGTH_SHORT).show();
                ...
                Intent vai_ao_resultado = new Intent(FemaleFriends.this, ResultActivity.class);
        ...
        bt_adicionar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int form = 0; form < 1; form ++)
                {
                    ...
                    final TextView txtVw_escolhanome = new TextView(FemaleFriends.this);
                    ...
                    final AutoCompleteTextView nome_autocomplete_field = new AutoCompleteTextView(FemaleFriends.this);
                    nome_autocomplete_field.setId(form + 1);
                    final int index2 = form;
                    nome_autocomplete_field.setAdapter(nomes_femininos);
                    ...
                    final TextView txtVw_escolhaparte = new TextView(FemaleFriends.this);
                    ...
                    final Spinner galinha_spinner = new Spinner(FemaleFriends.this);
                    ...
                    final TextView txtVw_escolhaacao = new TextView(FemaleFriends.this);
                    ...
                    final AutoCompleteTextView nome_acao_field = new AutoCompleteTextView(FemaleFriends.this);
                    ...
                    final TextView linha_separador = new TextView(FemaleFriends.this);
                    ...
                    final Button bt_delete_form = new Button(FemaleFriends.this);
                    ...
                    final TextView linha_separador2 = new TextView(FemaleFriends.this);
                    ...
                    final TextView linha_separador3 = new TextView(FemaleFriends.this);
